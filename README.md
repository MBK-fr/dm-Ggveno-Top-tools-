...
### DevSecOps
* [SonarQube](https://www.sonarsource.com/products/sonarqube/downloads/) - An open-source platform that performs static code analysis to detect vulnerabilities, code smells, and bugs.
* [Snyk](https://github.com/snyk/cli) - Snyk CLI scans and monitors your projects for security vulnerabilities.
* [Veracode](https://www.veracode.com/) - Offers a holistic, scalable way to manage security risk across your entire application portfolio.
### RootKit
